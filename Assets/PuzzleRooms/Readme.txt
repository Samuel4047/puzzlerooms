...
// This file was auto-generated by uMod Build Engine 2.0 for 'PuzzleRooms'

#Requirements

The requirements for 'PuzzleRooms' are as follows:
...
The content types fhat can be included for '%PuzzleRooms' are as follows:

	Scene mods: Yes
	Prefab mods: Yes
	Script mods: Yes

The parent folder of this file called 'PuzzleRooms' is known as the 'Mod Folder' and this is where all mod content should be placed in order for it to be exported. 
